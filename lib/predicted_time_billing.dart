...
import 'package:pqt_fourth/join_medical_queue.dart';
import 'package:slide_countdown_clock/slide_countdown_clock.dart';

import 'home_page.dart';

// ignore: must_be_immutable
class PredictBilling extends StatefulWidget {
  int displayOutput;
  var billingPosition;
  ...
  PredictBilling(
    ...
    this.getPosition,
    this.documentId,
    this.billingPosition,
    this.entireTimer,
  );

  @override
  _PredictBillingState createState() => _PredictBillingState();
}

class _PredictBillingState extends State<PredictBilling> {
  ...
  Future refresh() async {
    ...
    setState(() {
      refreshedOutput = widget.displayOutput;
      isRefreshed = true;
    });
    return build;
  }
          ...
          child: ListView(children: [
            Column(
              children: [
                ...
                Text(
                  "Time until you reach the Consultation Billing desk",
                  style: TextStyle(
                    color: Colors.blue,
                    fontSize: 25,
                    fontWeight: FontWeight.bold,
                ...
                Card(
                  ...
                  child: Container(
                    ...
                    child: SlideCountdownClock(
                      duration: Duration(
                        minutes: widget.billingPosition != 1.0
